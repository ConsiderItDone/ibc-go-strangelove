...
./simd add-genesis-account validator001 100000000stake --keyring-backend=test

./simd gentx validator001 "100000000stake" --amount="100000000stake" --keyring-backend=test --chain-id=ibcgo --from=validator001
./simd collect-gentxs
